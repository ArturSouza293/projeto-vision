...
export const KYC_DOSSIERS: Record<string, ClientKYC> = {
  ...
  // v10 — persona 13: Sônia, A Guardiã do Legado.
  sonia: {
    perfilPessoal: {
      ramo: "Educação (ex-proprietária de escola de idiomas, vendida)",
      cargo: "Aposentada",
      contadorAdvogado: "Contador: sim · Advogado: a filha Letícia (sucessório)",
      conhecimentoFinanceiro: "intermediário",
      interesses: ["bem-estar do filho", "leitura", "doações para inclusão"],
      admira: ["pessoas que cuidam de causas de PcD"],
      hobbies: ["jardinagem", "grupos de mães atípicas"],
      viagens: { gosta: false, nota: "evita viajar — rotina de cuidados do Bernardo" },
      pets: ["gata (Mel)"],
      comoSerChamado: "Dona Sônia",
      assuntoQuente: "O futuro do Bernardo quando ela faltar",
      reguaInvestimentos: 5,
      reguaBanking: 7,
      nps: 9,
      npsNota: "Promotora — relação longa, confia no gerente",
      funcionarioBanco: false,
      pessoaQueMaisImporta: "Bernardo (filho, dependente integral)",
    },
    perfilFamiliar: {
      moraCom: "filho Bernardo (40, dependente integral)",
      filhos: [
        { nome: "Bernardo", idade: 40, nota: "deficiência intelectual — maior incapaz (interditado)" },
        { nome: "Letícia", idade: 38, nota: "advogada — provável futura curadora" },
      ],
      arvoreGenealogica: [
        { parentesco: "filho", nome: "Bernardo", banco: "Bradesco (conta vinculada, curatela)", temContaBradesco: true },
        { parentesco: "filha", nome: "Letícia", banco: "Bradesco", temContaBradesco: true, isDecisor: true },
        { parentesco: "marido (falecido)", nome: "Joaquim", banco: "—" },
      ],
    },
    relacionamento: {
      temasSensiveis: [
        "Viuvez recente (4 anos) — sensibilidade ao falar do Joaquim.",
        "Medo central: Bernardo desamparado. Conduzir tudo pela ótica de proteção do filho.",
        "Não sobrecarregar a Letícia com a curatela.",
      ],
      canaisPreferidos: ["Agência (presencial)", "telefone"],
      frequencia: "Mensal — a filha participa das decisões grandes",
      estiloComunicacao: "Cuidadoso, sem jargão, foco em segurança",
      conjugeClienteBradesco: false,
      filhosClientesBradesco: true,
      resumoIAFicha:
        "Decumulação + sucessão multigeracional. Prioridade: liquidez para ITCMD sem vender a sala comercial (renda do filho) + estrutura de renda vitalícia para o Bernardo.",
    },
    ativosFinanceiros: {
      origemCapital: "Venda da escola de idiomas + herança do marido (Joaquim)",
      saldoConsolidadoBanco: 2400000,
      atualizadoEm: "2026-05-10",
    },
    ativosNaoFinanceiros: {
      imoveisProprios: 2,
      imoveisInvestimento: { qtd: 1, receitaMensal: 6000, nota: "Sala comercial alugada (SP) — renda do Bernardo" },
      imoveisExterior: 0,
      empresas: [],
    },
    fluxoCaixa: {
      despesasFixas: [
        { categoria: "Custo de vida", valor: 6000 },
        { categoria: "Cuidados do Bernardo", valor: 6000 },
        { categoria: "Saúde (dela)", valor: 2500 },
        { categoria: "Manutenção dos imóveis", valor: 1500 },
        { categoria: "Lifestyle / doações", valor: 500 },
      ],
      doacoes: { realiza: true, descricao: "instituições de inclusão (PcD)" },
      alertas: [
        { texto: "Sem testamento finalizado — risco sucessório alto para o Bernardo.", severidade: "alta" },
        { texto: "Liquidez para ITCMD ainda não dimensionada (imóveis em SP).", severidade: "media" },
      ],
      resumoIAGastos:
        "Cuidados do Bernardo são ~36% do gasto e crescem com inflação médica — dimensionar o legado acima do IPCA.",
      irPreCarregado: {
        anoBase: 2025,
        rendaTributavel: 222000,
        impostoDevido: 38000,
        bensEDireitos: 5550000,
        observacoes: "Aluguel + carteira; conferir tratamento da previdência.",
      },
      cartao: {
      ...
      insights: [
        ...
        "Sala comercial gera R$ 6 mil/mês — núcleo da renda do filho; preservar na sucessão.",
      ],
      atualizadoEm: "2026-05-10",
    },
    posicaoInternacional: { contaInternacional: false, investeExterior: false },
    planejamentos: { momentoDeVida: "Decumulação + sucessão multigeracional (legado)" },
    protecao: {
      planejamentoSucessorio:
        "Parcial/crítico — sem testamento finalizado; curatela do Bernardo (Letícia) em andamento; sem estrutura de renda dedicada. Tipo pretendido: legado (renda vitalícia ao dependente).",
      segurosExternos: [
        { tipo: "Saúde (ela)", possui: true, seguradora: "Bradesco Saúde", cobertura: "Plano sênior", bemCoberto: "Saúde (ela)" },
        { tipo: "Saúde (Bernardo)", possui: true, seguradora: "Bradesco Saúde", cobertura: "Plano integral PcD", bemCoberto: "Saúde (Bernardo)" },
        { tipo: "Residencial", possui: true, seguradora: "Porto Seguro", bemCoberto: "Residência (SP)", vigenciaFim: "2026-11-30" },
        { tipo: "Vida", possui: true, seguradora: "(apólice antiga)", cobertura: "Subdimensionada — lacuna p/ liquidez sucessória", valorCobertura: 300000, resgatavel: false },
      ],
      segurosInternos: [
        { tipo: "VGBL (em renda)", possui: true, seguradora: "Bradesco Vida e Previdência", cobertura: "Renda mensal vitalícia", valorCobertura: 450000, resgatavel: true },
      ],
      tipoSucessao: "legado",
    },
    historicoPatrimonial: [
      { ano: 2019, descricao: "Venda da escola de idiomas", valor: 1800000, tipo: "passado", kind: "entrada" },
      { ano: 2022, descricao: "Herança do Joaquim (seguro + sala comercial)", valor: 1500000, tipo: "passado", kind: "entrada" },
      { ano: 2027, descricao: "Estruturar o fundo de legado do Bernardo", tipo: "futuro", kind: "saida" },
    ],
  },
};
